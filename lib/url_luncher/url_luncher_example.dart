...
class UrlLuncherExample extends StatefulWidget {
  const UrlLuncherExample({super.key, required this.title});
  final String title;

  @override
  State<UrlLuncherExample> createState() => _UrlLuncherExampleState();
}

class _UrlLuncherExampleState extends State<UrlLuncherExample> {
